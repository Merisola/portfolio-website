...
const devProjects = [
  {
    title: "Alchemize-UI",
    description:
      "A headless component library built with Radix UI and Tailwind CSS.",
  ...
  },
  {
    title: "Nexus Ledger",
    description:
      "Full-stack financial tracking app with real-time data visualization.",
...
export default function PersonaPage() {
  ...
  const projects = persona === "dev" ? devProjects : pmProjects;
        ...
        <section id="snippets">
          {persona === "dev" ? (
            ...
            <div className="py-20 text-center border-t border-white/5 bg-[#080808]">
              {/* This is where your future StrategyShowcase would go */}
